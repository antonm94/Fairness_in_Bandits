...
if __name__ == '__main__':
    ...
    bandits = [NormalBandits([0, 0, 0, 0], [1, 0.5, 0.3, 0.2], data_set_name='D0', divergence_fun=R_DIV),
          ...
          #   --> implied by previous  NormalBandits([1, 0], [1, 10], data_set_name='D3', divergence_fun=R_DIV)]
    ...
    #                 NormalFairSDTest(N_ITERATIONS, bandit, T, e1, [e2_v], delta[1:], mean_0=mean_0, alpha_0=alpha_0,
